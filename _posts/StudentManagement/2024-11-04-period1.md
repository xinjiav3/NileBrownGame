...
<body>
  ...
  <script>
    function fetchRequest(tableNumber) {
      ...
      window.location.href = `/portfolio_2025/tabledetails?table=${tableNumber}&period=1`;
    }
    ...
    function searchStudent() {
      ...
      fetch("http://127.0.0.1:8085/api/students/find", {
        method: "POST",
        headers: {
      ...
      .then(data => {
        ...
        window.location.href = "/portfolio_2025/student-info?" + params.toString();
      })
      .catch(error => {
